...
- [Grammar Stakeholders](architecture/grammar-stakeholders.md)
...
- [Concurrency and Async](architecture/concurrency.md)
- [Performance Optimizations](architecture/performance-optimizations.md)
- [Desktop CLAN Proposal](architecture/desktop-clan-proposal.md)
...
- [Library Usage](integrating/library-usage.md)
- [JSON Output Reference](integrating/json-output.md)
- [JSON Schema](integrating/json-schema.md)
- [Diagnostic Contract](integrating/diagnostic-contract.md)
