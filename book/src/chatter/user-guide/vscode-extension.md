...
Run any of the 34 CLAN analysis commands directly from VS Code — no terminal needed (see [`status-matrix.md`](../../clan-reference/appendices/status-matrix.md) for the authoritative list).
