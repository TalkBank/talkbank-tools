...
`crate::test_fixtures` owns the shared helpers. Duplicating these
helpers in a new test module leads to drift between how production
and test code construct CHAT inputs and has caused real bugs to slip
through in the past.
