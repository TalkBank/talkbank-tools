...
///
/// Generated by `tree-sitter-grammar-utils`. Do not edit manually — regenerate with:
/// ```sh
...
///   --skip whitespaces \
///   > ~/talkbank/talkbank-tools/crates/talkbank-parser-tests/src/generated_traversal.rs
/// ```
///
/// The generated file is standalone (no external deps beyond `tree_sitter`)
/// and handles its own lint suppression via `#![allow(...)]`.
...
pub mod golden {
    ...
    pub fn run_word_roundtrip(parser: &TreeSitterParser) {
        ...
        for word in words {
            ...
            assert_eq!(serialized, word, "word roundtrip changed representation");
        }
    }
}
