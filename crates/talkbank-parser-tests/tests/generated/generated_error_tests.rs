...
#[ignore = "Status: not_implemented (Alignment)"]
/// Tests expected behavior.
#[test]
fn test_alignment_auto_begin_languages_eng_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    ...
    let expected_codes = vec!["Alignment"];
...
#[ignore = "Status: not_implemented (Complex)"]
/// Tests expected behavior.
#[test]
fn test_complex_auto_begin_languages_eng_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    ...
    let expected_codes = vec!["Complex"];
    for code in expected_codes {
        let expected = talkbank_model::ErrorCode::new(code);
        let has_expected = errors.errors.iter().any(|err| err.code == expected);
        assert!(has_expected, "Expected error code {}, but got: {:?}",
...
#[ignore = "Status: not_implemented (E209)"]
/// Tests expected behavior.
#[test]
...
#[ignore = "Status: not_implemented (E220)"]
/// Tests expected behavior.
#[test]
...
/// Tests expected behavior.
#[test]
fn test_e220_auto_utf8_begin_languages_2() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
...
#[ignore = "Status: not_implemented (E248)"]
/// Tests expected behavior.
#[test]
...
#[ignore = "Status: not_implemented (E258)"]
/// Tests expected behavior.
#[test]
...
#[ignore = "Status: not_implemented (E347)"]
/// Tests expected behavior.
#[test]
...
#[ignore = "Status: not_implemented (E350)"]
/// Tests expected behavior.
#[test]
fn test_e350_auto_begin_languages_eng_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let result = parser.parse_chat_file("@Begin\n@Languages:\teng\n@Participants:\tCHI Child\n@ID:\teng|corpus|CHI|||||Child|||\n*CHI:\thello [:] world .\n@End");
...
#[ignore = "Status: not_implemented (E366)"]
/// Tests expected behavior.
#[test]
fn test_e366_auto_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
...
#[ignore = "Status: not_implemented (E369)"]
/// Tests expected behavior.
#[test]
fn test_e369_auto_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
...
#[ignore = "Status: not_implemented (E376)"]
/// Tests expected behavior.
#[test]
...
fn test_e388_auto_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    ...
    let errors = sink.into_vec();
    let expected_codes = vec!["E311", "E316"];
...
#[ignore = "Status: not_implemented (E514)"]
/// Tests expected behavior.
#[test]
fn test_e514_auto_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
    let mut chat_file = parser.parse_chat_file_streaming("@UTF8\n@Begin\n@Languages:\teng\n@Participants:\tCHI Child\n@ID:\t|corpus|CHI|||||Child|||\n*CHI:\thello .\n@End", &sink);
...
#[ignore = "Status: not_implemented (E700)"]
/// Tests expected behavior.
#[test]
fn test_e700_auto_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
    let mut chat_file = parser.parse_chat_file_streaming("@UTF8\n@Begin\n@Languages:\teng\n@Participants:\tCHI Target_Child\n@ID:\teng|corpus|CHI|||||Target_Child|||\n*CHI:\thello .\n%mor:\tpro|I v|want\u{1} .\n@End", &sink);

    // Run validation
    chat_file.validate_with_alignment(&sink, None);

    let errors = sink.into_vec();
    let expected_codes = vec!["E700"];
...
#[ignore = "Status: not_implemented (E701)"]
/// Tests expected behavior.
#[test]
...
#[ignore = "Status: not_implemented (E703)"]
/// Tests expected behavior.
#[test]
fn test_e703_auto_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let result = parser.parse_chat_file("@UTF8\n@Begin\n@Languages:\teng\n@Participants:\tCHI Target_Child\n@ID:\teng|corpus|CHI|||||Target_Child|||\n*CHI:\thello .\n%mor:\t||||| .\n@End");
...
#[ignore = "Status: not_implemented (E707)"]
/// Tests expected behavior.
#[test]
...
#[ignore = "Status: not_implemented (E716)"]
/// Tests expected behavior.
#[test]
...
#[ignore = "Status: not_implemented (E717)"]
/// Tests expected behavior.
#[test]
fn test_e717_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
...
/// Tests expected behavior.
#[test]
fn test_e717_utf8_begin_languages_1() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
...
/// Tests expected behavior.
#[test]
fn test_e724_gra_circular_dependency_word_1_1() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
    let mut chat_file = parser.parse_chat_file_streaming("Word 1 → 2 (DISCOURSE)\nWord 2 → 1 (ADVMOD)\nWord 3 → 1 (PUNCT)\n\nCycle: 1 → 2 → 1", &sink);
...
/// Tests expected behavior.
#[test]
fn test_e724_gra_circular_dependency_word_1_3() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
    let mut chat_file = parser.parse_chat_file_streaming("Word 1 → 3 (FLAT)\nWord 2 → 3 (PUNCT)\nWord 3 → 1 (APPOS)  ← Points back to word 1!\nWord 4 → 1 (PUNCT)\n\nCycle: 1 → 3 → 1", &sink);
...
/// Tests expected behavior.
#[test]
fn test_e724_gra_circular_dependency_utf8_begin_languages_4() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
...
/// Tests expected behavior.
#[test]
fn test_e724_gra_circular_dependency_word_1_5() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
    let mut chat_file = parser.parse_chat_file_streaming("Word 1 → 2 (NSUBJ)\nWord 2 → 3 (ROOT)  ← ROOT shouldn't point to another word!\nWord 3 → 2 (OBJ)   ← Points back to word 2!\nWord 4 → 2 (PUNCT)\n\nCycle: 2 → 3 → 2", &sink);
...
#[ignore = "Status: not_implemented (Events)"]
/// Tests expected behavior.
#[test]
fn test_events_auto_begin_languages_eng_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let result = parser.parse_chat_file("@Begin\n@Languages:\teng\n@Participants:\tCHI Target_Child\n@ID:\teng|corpus|CHI|2;6|male|||Target_Child|||\n@Comment:\tNote: Events are non-alignable, like pauses\n*CHI:\tI &=laugh want cookie .\n%mor:\tpro|I v|laugh v|want n|cookie .\n@Comment:\tERROR: Event &=laugh shouldn't have a mor item (v|laugh is wrong)\n@Comment:\tMain tier alignable: I, want, cookie = 3 words (events excluded)\n@Comment:\tMor tier: Should be pro|I v|want n|cookie (3 items + terminator)\n@End");
...
#[ignore = "Status: not_implemented (Multiple)"]
/// Tests expected behavior.
#[test]
fn test_multiple_auto_begin_languages_eng_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let result = parser.parse_chat_file("@Begin\n@Languages:\teng\n@Participants:\tCHI Target_Child\n@ID:\teng|corpus|CHI|2;6|male|||Target_Child|||\n@Comment:\tNote: Each word in corrected form aligns separately\n*CHI:\tI <wanna> [: want to] <the> [: a] cookie .\n%mor:\tpro|I v|want n|cookie .\n@Comment:\tERROR: Replacements have \"want to\" (2 words) and \"a\" (1 word)\n@Comment:\tMain tier alignable: I, want, to, a, cookie = 5 words\n@Comment:\tMor tier: Should be pro|I v|want inf|to det|a n|cookie (5 items + terminator)\n@End");
    ...
    let expected_codes = vec!["Multiple"];
    for code in expected_codes {
        let expected = talkbank_model::ErrorCode::new(code);
        let has_expected = errors.errors.iter().any(|err| err.code == expected);
        assert!(has_expected, "Expected error code {}, but got: {:?}",
...
#[ignore = "Status: not_implemented (Omitted)"]
/// Tests expected behavior.
#[test]
fn test_omitted_auto_begin_languages_eng_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    ...
    let expected_codes = vec!["Omitted"];
    for code in expected_codes {
        let expected = talkbank_model::ErrorCode::new(code);
        let has_expected = errors.errors.iter().any(|err| err.code == expected);
        assert!(has_expected, "Expected error code {}, but got: {:?}",
...
#[ignore = "Status: not_implemented (Pauses)"]
/// Tests expected behavior.
#[test]
fn test_pauses_auto_begin_languages_eng_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let result = parser.parse_chat_file("@Begin\n@Languages:\teng\n@Participants:\tCHI Target_Child\n@ID:\teng|corpus|CHI|2;6|male|||Target_Child|||\n@Comment:\tNote: Pauses, events, actions don't align - only words\n*CHI:\tI (.) want cookie .\n%mor:\tpro|I v|pause v|want n|cookie .\n@Comment:\tERROR: Pause (.) shouldn't have a mor item (v|pause is wrong)\n@Comment:\tMain tier alignable: I, want, cookie = 3 words (pauses excluded)\n@Comment:\tMor tier: Should be pro|I v|want n|cookie (3 items + terminator)\n@End");
...
#[ignore = "Status: not_implemented (Tag)"]
/// Tests expected behavior.
#[test]
fn test_tag_auto_begin_languages_eng_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let result = parser.parse_chat_file("@Begin\n@Languages:\teng\n@Participants:\tCHI Target_Child\n@ID:\teng|corpus|CHI|2;6|male|||Target_Child|||\n@Comment:\tNote: Tag markers are alignable content\n*CHI:\tI want ± cookie .\n%mor:\tpro|I v|want n|cookie .\n@Comment:\tERROR: Tag marker ± should have a mor item\n@Comment:\tMain tier alignable: I, want, ±, cookie = 4 words\n@Comment:\tMor tier: Should have 4 items (missing item for ±)\n@End");
...
#[ignore = "Status: not_implemented (Terminator)"]
/// Tests expected behavior.
#[test]
fn test_terminator_auto_begin_languages_eng_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let result = parser.parse_chat_file("@Begin\n@Languages:\teng\n@Participants:\tCHI Target_Child\n@ID:\teng|corpus|CHI|2;6|male|||Target_Child|||\n@Comment:\tNote: Terminators (. ! ?) align for %mor and %gra\n*CHI:\tI want cookie .\n%mor:\tpro|I v|want n|cookie\n@Comment:\tERROR: %mor missing terminator (should end with .)\n@Comment:\tMain tier: 3 words + terminator = 4 alignable\n@Comment:\tMor tier: Only 3 items (missing terminator)\n@End");
    ...
    let expected_codes = vec!["Terminator"];
    for code in expected_codes {
        let expected = talkbank_model::ErrorCode::new(code);
        let has_expected = errors.errors.iter().any(|err| err.code == expected);
        assert!(has_expected, "Expected error code {}, but got: {:?}",
...
#[ignore = "Status: not_implemented (W210)"]
/// Tests expected behavior.
#[test]
fn test_w210_auto_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
    let mut chat_file = parser.parse_chat_file_streaming("@UTF8\n@Begin\n@Languages:\teng\n@Participants:\tCHI Target_Child\n@ID:\teng|corpus|CHI|||||Target_Child|||\n*CHI:\thello.\n@End", &sink);
...
#[ignore = "Status: not_implemented (W211)"]
/// Tests expected behavior.
#[test]
fn test_w211_auto_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
    let mut chat_file = parser.parse_chat_file_streaming("@UTF8\n@Begin\n@Languages:\teng\n@Participants:\tCHI Target_Child\n@ID:\teng|corpus|CHI|||||Target_Child|||\n*CHI:\thello ⌈world⌉.\n@End", &sink);
...
#[ignore = "Status: not_implemented (W603)"]
/// Tests expected behavior.
#[test]
fn test_w603_auto_utf8_begin_languages_0() -> Result<(), talkbank_parser_tests::test_error::TestError> {
    let parser = TreeSitterParser::new()?;
    let sink = talkbank_model::ErrorCollector::new();
