"""TalkBank CHAT transcription format"""
...
def _get_query(name, file):
    """Load a query file lazily and cache it in module globals."""
...
def __getattr__(name):
    """Resolve query constants lazily so import stays lightweight."""
...
def __dir__():
    """Expose lazy query constants in interactive discovery tools."""
