# spec   tools   src   bootstrap   EXAMPLES GUIDE

## Overview
Short summary for `spec/tools/src/bootstrap/EXAMPLES_GUIDE.md`. This document is intentionally concise; legacy detail has been trimmed.
