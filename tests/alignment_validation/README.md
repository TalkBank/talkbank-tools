# tests   alignment validation   README

## Overview
Short summary for `tests/alignment_validation/README.md`. This document is intentionally concise; legacy detail has been trimmed.
