# tests   component roundtrip tests   README

## Overview
Short summary for `tests/component_roundtrip_tests/README.md`. This document is intentionally concise; legacy detail has been trimmed.
